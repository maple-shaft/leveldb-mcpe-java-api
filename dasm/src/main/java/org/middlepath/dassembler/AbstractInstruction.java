...
public interface AbstractInstruction {
	...
	public static final byte BEQ_IMM = 0x06;
	public static final byte JMP_IMM = 0x07;
	public static final byte STA_REF = 0x08;
	public static final byte STB_REF = 0x09;
	public static final byte OUT_REF = 0x0A;
	public static final byte SUB_NOOP = 0x0B;
	public static final byte BEQ_REF = 0x0C;
	public static final byte JMP_REF = 0x0D;
